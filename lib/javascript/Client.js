...
function GenomeAnnotationAPI(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    this._check_job = function (job_id, _callback, _errorCallback) {
        ...
        return json_call_ajax("GenomeAnnotationAPI._check_job", 
     ...
     this.get_taxon = function (inputs_get_taxon, _callback, _errorCallback) {
        ...
        return json_call_ajax("GenomeAnnotationAPI.get_taxon",
     ...
     this.get_assembly = function (inputs_get_assembly, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_assembly",
     ...
     this.get_feature_types = function (inputs_get_feature_types, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_types",
     ...
     this.get_feature_type_descriptions = function (inputs_get_feature_type_descriptions, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_type_descriptions",
     ...
     this.get_feature_type_counts = function (inputs_get_feature_type_counts, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_type_counts",
     ...
     this.get_feature_ids = function (inputs_get_feature_ids, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_ids",
            [inputs_get_feature_ids], 1, _callback, _errorCallback);
    };
     ...
     this.get_features = function (inputs_get_features, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_features",
            [inputs_get_features], 1, _callback, _errorCallback);
    };
     ...
     this.get_features2 = function (params, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_features2",
     ...
     this.get_proteins = function (inputs_get_proteins, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_proteins",
     ...
     this.get_feature_locations = function (inputs_get_feature_locations, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_locations",
     ...
     this.get_feature_publications = function (inputs_get_feature_publications, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_publications",
            [inputs_get_feature_publications], 1, _callback, _errorCallback);
    };
     ...
     this.get_feature_dna = function (inputs_get_feature_dna, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_dna",
     ...
     this.get_feature_functions = function (inputs_get_feature_functions, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_functions",
     ...
     this.get_feature_aliases = function (inputs_get_feature_aliases, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_feature_aliases",
     ...
     this.get_cds_by_gene = function (inputs_get_cds_by_gene, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_cds_by_gene",
            [inputs_get_cds_by_gene], 1, _callback, _errorCallback);
    };
     ...
     this.get_cds_by_mrna = function (inputs_mrna_id_list, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_cds_by_mrna",
            [inputs_mrna_id_list], 1, _callback, _errorCallback);
    };
     ...
     this.get_gene_by_cds = function (inputs_get_gene_by_cds, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_gene_by_cds",
            [inputs_get_gene_by_cds], 1, _callback, _errorCallback);
    };
     ...
     this.get_gene_by_mrna = function (inputs_get_gene_by_mrna, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_gene_by_mrna",
            [inputs_get_gene_by_mrna], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_by_cds = function (inputs_get_mrna_by_cds, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_mrna_by_cds",
            [inputs_get_mrna_by_cds], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_by_gene = function (inputs_get_mrna_by_gene, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_mrna_by_gene",
            [inputs_get_mrna_by_gene], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_exons = function (inputs_get_mrna_exons, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_mrna_exons",
            [inputs_get_mrna_exons], 1, _callback, _errorCallback);
    };
     ...
     this.get_mrna_utrs = function (inputs_get_mrna_utrs, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_mrna_utrs",
            [inputs_get_mrna_utrs], 1, _callback, _errorCallback);
    };
     ...
     this.get_summary = function (inputs_get_summary, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.get_summary",
            [inputs_get_summary], 1, _callback, _errorCallback);
    };
     ...
     this.save_summary = function (inputs_save_summary, _callback, _errorCallback) {
        ...
        if (typeof arguments === 'function' && arguments.length > 1+2)
            throw 'Too many arguments ('+arguments.length+' instead of '+(1+2)+')';
        return json_call_ajax("GenomeAnnotationAPI.save_summary",
            [inputs_save_summary], 2, _callback, _errorCallback);
    };
