...
/**
 * <p>Original spec-file type: GenomeSaveDataV1</p>
 * 
 * 
 */
...
public class GenomeSaveDataV1 {
    ...
    public GenomeSaveDataV1 withData(Genome data) {
        this.data = data;
        return this;
    }
    ...
    public GenomeSaveDataV1 withHidden(Long hidden) {
        this.hidden = hidden;
        return this;
    }
    ...
    public GenomeSaveDataV1 withProvenance(List<ProvenanceAction> provenance) {
        this.provenance = provenance;
        return this;
    }
    ...
    public String toString() {
        return ((((((((("GenomeSaveDataV1"+" [data=")+ data)+", hidden=")+ hidden)+", provenance=")+ provenance)+", additionalProperties=")+ additionalProperties)+"]");
    }
